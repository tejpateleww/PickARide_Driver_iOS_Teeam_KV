...
open class MSBBarChartView: UIView {
    ...
    private var barLayerList : [CAShapeLayer] = []
...
//            }
//
//            for sublayer in subLayers.enumerated()
//            {
//                if let shapeLayer = sublayer.element as? CAShapeLayer
//                {
//                    if ((shapeLayer.path?.contains(touchLocation, using: .evenOdd, transform: .init())) != nil)
//                    {
//                        // This touch is in this shape layer
//                        touchInLayer = true
//                    }
//                }else if let clLayer = sublayer.element as CALayer?
//                {
//                    if (clLayer.contains(touchLocation))
//                    {
//                        //touchInLayer = true
//                    }
//
...
//        }
//
//        print("the layer as \(touchInLayer)")
//
//    }
...
//        {
//            print("Here you will have the layer as \(touchedLayer)")
...
//        let hitPresentationLayer = self.mainLayer.presentation()?.hitTest(locationInView)
...
//        super.touchesBegan(touches, with: event)
//
//        if let touch = touches.first, let points = touch.location(in: self) as CGPoint?
//        {
//            if (self.barLayer?.shadowPath
//            {
//                print("Here you will have the layer as touchedLayer")
//            }
//        }
